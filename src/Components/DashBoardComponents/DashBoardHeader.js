  ...
  return (
    <>
      <Chip
        ...
        variant="outlined"
        onClick={handleCalenderVisible}
      />
      <Dialog
        onClose={handleCalenderVisible}
    ...
    <div>
      <Grid container spacing={3} className={classes.root}>
        ...
        <Grid item xs={6}>
          <Button
            variant="contained"
            className={classNames(classes.btnOrange, classes.btn)}
          ...
          <Button
            variant="contained"
            className={classNames(classes.btnGreen, classes.btn)}
          >
            Settle up
          </Button>
          <Dialog
